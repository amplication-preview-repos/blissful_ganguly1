...
@InputType()
class PromotionUpdateManyWithoutPromotionsImagesInput {
...
export { PromotionUpdateManyWithoutPromotionsImagesInput as PromotionUpdateManyWithoutPromotionsImagesInput };
