...
@InputType()
class PromotionCreateNestedManyWithoutPromotionsImagesInput {
...
export { PromotionCreateNestedManyWithoutPromotionsImagesInput as PromotionCreateNestedManyWithoutPromotionsImagesInput };
