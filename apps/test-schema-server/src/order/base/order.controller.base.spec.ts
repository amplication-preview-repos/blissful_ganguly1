...
const CREATE_INPUT = {
  additional: "exampleAdditional",
  address: "exampleAddress",
  atl: "true",
  billingAddress: "exampleBillingAddress",
  billingCountry: "exampleBillingCountry",
  billingPostcode: "exampleBillingPostcode",
  billingState: "exampleBillingState",
  billingSuburb: "exampleBillingSuburb",
  country: "exampleCountry",
  createdAt: new Date(),
  deliveryAddress: "exampleDeliveryAddress",
  deliveryCountry: "exampleDeliveryCountry",
  deliveryPostcode: "exampleDeliveryPostcode",
  deliveryState: "exampleDeliveryState",
  deliverySuburb: "exampleDeliverySuburb",
  email: "exampleEmail",
  fullname: "exampleFullname",
  fundraiserTotal: 42.42,
  id: "exampleId",
  orderId: 42,
  orderTotal: 42.42,
  phone: "examplePhone",
  ...
  supportNotes: "exampleSupportNotes",
