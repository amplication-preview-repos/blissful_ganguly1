...
@InputType()
class ActivityCreateNestedManyWithoutUserRolesInput {
...
export { ActivityCreateNestedManyWithoutUserRolesInput as ActivityCreateNestedManyWithoutUserRolesInput };
